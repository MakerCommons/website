...
export const t = {
  en: {
    ...
    support: {
      eyebrow: 'Support',
      badge: 'Coming later — on purpose',
      title: 'Supporting the commons',
      body1: 'Donations and sponsorship aren’t a priority yet. The collective is small and just getting started — we’d rather earn your support by shipping useful things first.',
      body2: 'When hosting costs or bounties make funding worthwhile, we’ll set it up — and, like everything here, the books will be transparent by default. No tool’s core function will ever sit behind a payment.',
      helpTitle: 'The best way to help right now is free:',
      ways: [
      ...
      ctaBring: 'Bring a problem →',
      ctaContribute: 'Ways to contribute',
    },
    cta: {
  ...
  fr: {
    ...
    support: {
      eyebrow: 'Soutenir',
      badge: 'Plus tard — et c’est voulu',
      title: 'Soutenir le commun',
      body1: 'Les dons et le sponsoring ne sont pas une priorité pour l’instant. Le collectif est petit et débute à peine — on préfère d’abord mériter votre soutien en livrant des choses utiles.',
      body2: 'Quand les coûts d’hébergement ou des primes le justifieront, on mettra ça en place — et, comme tout ici, les comptes seront transparents par défaut. Jamais la fonction principale d’un outil ne sera derrière un paiement.',
      helpTitle: 'La meilleure façon d’aider, maintenant, est gratuite :',
      ways: [
        'Apporter un problème que vous ou vos proches avez vraiment.',
        'Construire un outil, ou aider à en relire et améliorer un.',
        'Mettre une étoile aux dépôts et partager le manifeste.',
      ],
      ctaBring: 'Proposer un problème →',
      ctaContribute: 'Comment contribuer',
    },
    cta: {
